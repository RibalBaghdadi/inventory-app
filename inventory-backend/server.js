...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://ribalbaghdadi33:M9bz9s18Ec1Qhcx5@cluster0.qtdppwv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
    .then(() => {
